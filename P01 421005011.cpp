...
#include <glew.h>
#include <glfw3.h>
//Bibliotecas para la generacion de numeros aleatorios
#include <stdlib.h>
#include <time.h>
...
int main()
{
	...
	//CREAR VENTANA
	GLFWwindow *mainWindow = glfwCreateWindow(WIDTH, HEIGHT, "Practica 1: Introducción a OpenGL", NULL, NULL);
 ...
 //Crear tr�angulo
	...
	{	
		//Asignacion de valores a las variables de color
		...
		Sleep(2000); //Tiempo de espera para ser visible
